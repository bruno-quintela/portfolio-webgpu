...
import { ComputeSnowParticles } from '@/components/snowParticles';
...
import SPRITETEXTURE from "@/assets/circle_05.png";
...
const Scene = () => {
  ...
  return (
    <>
      ...
      <ComputeSnowParticles ref={particleRef} texture={particleTexture} />
      {/*front plane */}
      <mesh
        ref={meshRef4}
        scale={[1.*w, 1.*h, 1]}
