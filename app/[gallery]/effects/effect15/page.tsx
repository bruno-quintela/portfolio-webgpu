...
const Scene = () => {
  ...
  const [rawMap, rawMap2, depthMap, normalMap] = useTexture(
    [TEXTUREMAP.src, TEXTUREMAP2.src, DEPTHMAP.src, NORMALMAP.src], 
    () => {
      setIsLoading(false);
  ...
  const { material, material2, uniforms } = useMemo(() => {
    ...
    finalColor2 = vec4(textureSample.rgb, textureSample.a);
