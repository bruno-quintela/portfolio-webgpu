...
import TEXTUREMAP from '@/assets/raw-10.png';
import NORMALMAP from '@/assets/normal.png';
import DEPTHMAP from '@/assets/depth-10.png';
...
const Scene = () => {
  ...
  const { material, uniforms } = useMemo(() => {
    ...
    const heatIntensity = float(0.02); // Adjust for stronger/weaker effect
    
    // Add heat distortion calculation after depth calculation
    const heat = sin(
      tUv.x.mul(10.0) // X frequency
        .add(tUv.y.mul(10.0)) // Y frequency
     ...
     .mul(depth.pow(8.0)); // Stronger in deeper areas
